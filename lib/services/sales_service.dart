...
class SalesService {
  ...
  Future<SalesMaster?> masters() async {
    try {
      final url =
          '$baseurl/api/method/goshala_sanpra.custom_pyfile.login_master.salesMasters';
      ...
      if (response.statusCode == 200) {
        return SalesMaster.fromJson(response.data["data"]);
      } else {
  ...
  Future<bool> delete(CustomerList customer) async {
    try {
      final url = '$baseurl/api/resource/Delivery Note/${customer.name}';
  ...
  Future<bool> create(Sale customer) async {
    try {
      print(customer.toJson());
      final url = '$baseurl/api/resource/Delivery Note';
